package cz.kavan.radek.maprani.config;
...
import cz.kavan.radek.maprani.security.service.RepositoryUserDetailsService;
import cz.kavan.radek.maprani.security.service.SimpleSocialUserDetailsService;
...
public class SecurityContext extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .formLogin().loginPage("/login").loginProcessingUrl("/login/authenticate")
                ...
                .antMatchers("/auth/**", "/login", "/signin/**", "/signup/**", "/user/register/**").permitAll()
